            ...
            <div class="col-lg-4">
              <div class="card card-outline card-primary">
                <div class="card-header text-center">
                  <a href="#" class="h1 bluetext"><b>Login</b></a>
                </div>
                <div class="card-body">
                  <p class="login-box-msg text-center mb-4">Sign in to start your session</p>
                  <form method="post" id="quickForm" action="processes.php">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                      <button type="submit" class="btn btn-primary" name="login" id="login" style="width: 100%;">Sign In</button>
                    </div>
                  </form>
                  <p class="mb-1 mt-2">
