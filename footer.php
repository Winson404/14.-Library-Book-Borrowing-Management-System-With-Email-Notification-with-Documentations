    ...
    <div class="container d-md-flex py-4">
      <div class="row p-3">
          <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            <label>Mission</label>
            <p class="text-sm text-justify text-muted">We are a smart and green University that advances education, technological and professional instruction, research and innovation, community engagement services and progressive leadership in arts, sciences and technology that are relevant to the needs of our communities. We produce graduates and life-long learners equipped with knowledge that enhances lives and invigorates economic development.</p>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            <label>Vision</label>
            <p class="text-sm text-justify text-muted">By 2040, Southern Leyte State University is a leading higher education institution that advances knowledge, innovation and compassion for humanity, creating an inclusive society and a sustainable world.</p>
          </div>
          <div class="col-12">
            <hr>
