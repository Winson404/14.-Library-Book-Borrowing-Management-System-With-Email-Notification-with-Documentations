                                ...
                                <div class="row">
                                    <div class="col px-0">
                                        <div>
                                            ...
                                            <h6 class="text-primary"><a href="book-info.php?book_id=<?php echo $row['book_id']; ?>"><?php echo ucwords($row['book_name']); ?></a> by <?php echo ucwords($row['book_author']); ?></a></h6>
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn bg-gradient-primary" name="borrow_book_search-book" id="delete_book"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                    ...
                    <div class="list-group">
                        <?php 
                            $fetch = mysqli_query($conn, "SELECT * FROM book_list LIMIT 50");
