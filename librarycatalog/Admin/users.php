                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id="users_data">
                      ...
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#view<?php echo $row['user_Id']; ?>"><i class="fa-solid fa-eye"></i> View</button>
                          <?php if($row['user_status'] == 'Confirmed'): ?>
                          <button type="button" class="btn btn-success btn-sm" disabled><i class="fa-solid fa-circle-check"></i> Approve</button>
                          <?php else: ?>
                          <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#approve<?php echo $row['user_Id']; ?>"><i class="fa-solid fa-circle-check"></i> Approve</button>
                          <?php endif; ?>
