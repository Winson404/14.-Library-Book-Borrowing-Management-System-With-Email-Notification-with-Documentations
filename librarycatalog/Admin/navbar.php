...
<head>
  ...
  <title>Library App Catalog</title>
  <!-- FILE ICON -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Library App Catalog</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="category.php" class="nav-link text-light"><i class="fa-solid fa-puzzle-piece"></i><p>&nbsp;&nbsp; Manage Category</p></a>
              </li>
              <li class="nav-item">
                <a href="book.php" class="nav-link text-light"><i class="fa-solid fa-book"></i><p>&nbsp;&nbsp; Manage Book</p></a>
              </li>
              <li class="nav-item">
