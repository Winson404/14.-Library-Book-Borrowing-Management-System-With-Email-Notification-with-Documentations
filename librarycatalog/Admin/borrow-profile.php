...
<?php 
    include 'navbar.php'; 
    if(isset($_GET['borrowed_book_Id']))
    $borrowed_book_Id = $_GET['borrowed_book_Id'];
    $fetch = mysqli_query($conn, "SELECT * FROM borrowed_book JOIN book ON borrowed_book.book_id=book.book_id JOIN users ON borrowed_book.user_id=users.user_Id WHERE borrowed_id='$borrowed_book_Id'");
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="updateprofile">
                      <div class="form-group row">
                        <label for="First name" class="col-sm-2 col-form-label">Catalog number</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $row['catalog_number']; ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="Suffix" class="col-sm-2 col-form-label">Shelf location</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $row['shelf_location']; ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Date of birth" class="col-sm-2 col-form-label">Availability</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo ''.$row['availability'].' out of '.$row['orig_available'].' '; ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
