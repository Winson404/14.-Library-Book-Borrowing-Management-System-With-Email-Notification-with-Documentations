		...
		if(mysqli_num_rows($check)===1) {
				...
				if($status == 'Confirmed') {
					if($user_type == 'User') {
						...
						$_SESSION['message'] = "Only students can login here.";
		...
		if(mysqli_num_rows($check)===1) {
				...
				if($status == 'Confirmed') {
					if($user_type == 'Admin') {
						...
						$_SESSION['message'] = "Only system administrators can login here.";
				    $_SESSION['text'] = "Please try again.";
				    $_SESSION['status'] = "error";
				...
				$_SESSION['message'] = "Incorrect passwordFDF.";
		    $_SESSION['text'] = "Please try again.";
		    $_SESSION['status'] = "error";
				header("Location: login_admin.php");
		}
		...
		if(mysqli_num_rows($check_email) > 0 ) {
            ...
            // if everything is ok, try to upload file
                ...
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                	...
                	$save = mysqli_query($conn, "INSERT INTO users (firstname, middlename, lastname, suffix, gender, dob, age, address, email, contact, password, level_section, image, date_registered) VALUES ('$firstname', '$middlename', '$lastname', '$suffix', '$gender', '$dob', '$age', '$address', '$email', '$contact', '$password', '$course_year', '$file','$date_registered')");
