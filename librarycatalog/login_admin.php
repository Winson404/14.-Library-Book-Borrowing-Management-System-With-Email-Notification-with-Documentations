            ...
            <div class="col-lg-4">
              <div class="card card-outline card-primary">
                <div class="card-header text-center">
                  <a href="#" class="h1 bluetext"><b>Admin login</b></a>
                </div>
                <div class="card-body">
                  ...
                  <form action="processes.php" method="post" id="quickForm">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                      <button type="submit" class="btn btn-primary" name="login_admin" id="login" style="width: 100%;">Sign In</button>
                    </div>
                  </form>
                  <p class="mb-1 mt-2">
                  ...
                  <p class="mb-0">
                    <a href="register_admin.php" class="text-center bluetext">Register a new membership</a>
                  </p>
                </div>
              </div>
            </div>
