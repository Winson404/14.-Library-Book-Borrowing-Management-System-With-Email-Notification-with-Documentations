          ...
          <div class="col-lg-4 mt-5">
            <div class="card card-outline card-primary">
              ...
              <div class="card-body">
                ...
                <form action="verifycode.php" method="post" id="quickForm">
                  ...
                  <div class="d-flex justify-content-center mt-3">
                    <button type="submit" class="btn btn-success" name="sendcode" style="width: 100%;">Continue</button>
                  </div>
                </form>
                <p class="mb-1 mt-2">
                  <a href="forgot-password.php">Not you?</a>
                </p>
              </div>
            </div>
          </div>
